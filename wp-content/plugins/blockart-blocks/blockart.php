...
! defined( 'BLOCKART_VERSION' ) && define( 'BLOCKART_VERSION', '1.1.0' );
! defined( 'BLOCKART_PLUGIN_FILE' ) && define( 'BLOCKART_PLUGIN_FILE', __FILE__ );
! defined( 'BLOCKART_PLUGIN_DIR' ) && define( 'BLOCKART_PLUGIN_DIR', dirname( __FILE__ ) );
! defined( 'BLOCKART_PLUGIN_DIR_URL' ) && define( 'BLOCKART_PLUGIN_DIR_URL', plugin_dir_url( __FILE__ ) );
! defined( 'BLOCKART_ASSETS' ) && define( 'BLOCKART_ASSETS', dirname( __FILE__ ) . '/assets' );
...
! defined( 'BLOCKART_LANGUAGES' ) && define( 'BLOCKART_LANGUAGES', dirname( __FILE__ ) . '/languages' );
