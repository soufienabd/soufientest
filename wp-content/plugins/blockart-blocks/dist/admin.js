...
;// CONCATENATED MODULE: ./src/admin/helpers/setRating.js


/* harmony default export */ const setRating = (function (ev) {
...
;// CONCATENATED MODULE: ./src/admin/hooks/useCurrentCSSClass.js

/* harmony default export */ const useCurrentCSSClass = (function (selector) {
...
/* harmony default export */ const getting_started = (function () {
  useCurrentCSSClass('#toplevel_page_blockart a[href="admin.php?page=blockart#/getting-started"]:not(.toplevel_page_blockart)');
...
/* harmony default export */ const settings = (function () {
  ...
  useCurrentCSSClass('#toplevel_page_blockart a[href="admin.php?page=blockart#/settings"]');
  var toastOptions = {
...
/* harmony default export */ const App = (function () {
  ...
  (0,external_wp_element_namespaceObject.useEffect)(function () {
    ...
    el.addEventListener('click', setRating);
    return function () {
      el.removeEventListener('click', setRating);
    };
  }, []);
